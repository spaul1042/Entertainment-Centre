    ...
    return (
      <>
        {this.state.form_or_not ? (
          <UpdateTodoForm
            func={this.save}
            present_todoname={this.state.Dtodo}
          />
        ) : (
          <div className="singleTodoConatiner">
            <span onClick={this.todo_done} className="SingleTodo">
              {this.state.Dtodo}
            </span>
            <br/>
            <button className="btn1" onClick={this.deletetodo}>
              Delete
            </button>
            <button className="btn2" onClick={this.updatetodo}>
              Update
            </button>
